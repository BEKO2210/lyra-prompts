---
id: "#3674"
titel: "A sequence follows the rule 'multiply by 2 and then subtract"
kategorie: "Spezielle Situationen"
unterkategorie: "Importiert"
tags: ["sequence", "follows", "rule", "multiply", "subtract"]
...
```
A sequence follows the rule "multiply by 2 and then subtract 3" starting with the number 4. What will be the 5th term in this sequence?
```
