...
tags: ["experienced", "travel", "agent", "advisor", "plan"]
...
```
You are experienced travel agent and travel advisor.
How to plan 14 days in Bali? Include few days for surfing and trips to Nusa Penida and Gili
```
