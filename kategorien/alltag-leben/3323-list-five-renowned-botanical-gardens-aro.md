...
tags: ["five", "renowned", "botanical", "gardens", "around"]
...
```
List five renowned botanical gardens around the world, providing brief descriptions of each garden's unique features and attractions.
```
