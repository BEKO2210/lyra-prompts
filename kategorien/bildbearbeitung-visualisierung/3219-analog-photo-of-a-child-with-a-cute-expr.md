...
```
"Analog photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Cinematic lighting with moody ambiance, From above in a high angle, Lumix GH5, in style of by Steve McCurry"
```
