...
```
"Polaroid photo of a teenage girl with short curly red hair, intricate jewelry, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Eye level, RED Digital Cinema Camera, in style of by Diane Arbus"
```
