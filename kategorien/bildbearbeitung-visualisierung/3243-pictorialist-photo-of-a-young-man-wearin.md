...
```
"pictorialist photo of a young man wearing a suit and tie, expressive facial features, wearing a sundress, interacting with nature, High angle view, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Fujifilm X-T4, in style of by Vivian Maier"
```
