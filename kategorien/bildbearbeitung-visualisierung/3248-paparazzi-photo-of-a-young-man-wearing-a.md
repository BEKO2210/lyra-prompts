...
```
"paparazzi photo of a young man wearing a suit and tie, expressive facial features, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, on a serene beach at golden hour, Bounced lighting, From above in a high angle, Canon EOS 5D, in style of by Steve McCurry"
```
