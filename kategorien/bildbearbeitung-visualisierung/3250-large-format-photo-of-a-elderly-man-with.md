...
```
"large format photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, in mid-dance move, Head shot with dramatic lighting, in a bustling city square during sunset, Cinematic lighting with moody ambiance, Eye level, ARRI ALEXA 65, in style of by Vivian Maier"
```
