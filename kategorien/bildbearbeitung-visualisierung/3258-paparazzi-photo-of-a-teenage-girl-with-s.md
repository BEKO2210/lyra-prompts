...
```
"paparazzi photo of a teenage girl with short curly red hair, expressive facial features, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, From below in a low angle, ARRI ALEXA 65, in style of by Vivian Maier"
```
