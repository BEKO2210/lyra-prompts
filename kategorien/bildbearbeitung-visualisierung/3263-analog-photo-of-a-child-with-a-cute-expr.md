...
```
"Analog photo of a child with a cute expression and messy hair, expressive facial features, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, in a bustling city square during sunset, Golden hour light casting a warm glow, From below in a low angle, Pentax 645Z, in style of by Diane Arbus"
```
