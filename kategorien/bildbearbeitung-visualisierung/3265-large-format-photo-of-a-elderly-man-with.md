...
```
"large format photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, interacting with nature, Close up on the face, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Eye level, Aaton LTR, in style of by Annie Leibovitz"
```
