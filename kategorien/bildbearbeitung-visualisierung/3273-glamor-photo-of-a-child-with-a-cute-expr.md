...
```
"glamor photo of a child with a cute expression and messy hair, striking tattoos, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Eye level, Pentax 645Z, in style of by Diane Arbus"
```
