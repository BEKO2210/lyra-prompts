...
```
"beauty photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, interacting with nature, Close up on the face, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, Dutch angle, Canon EOS 5D, in style of by Steve McCurry"
```
