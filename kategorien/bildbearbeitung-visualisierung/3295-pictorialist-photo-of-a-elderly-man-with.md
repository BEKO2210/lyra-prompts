...
```
"pictorialist photo of a elderly man with a beard and glasses, captivating eyes, wearing a sundress, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Dutch angle, RED Digital Cinema Camera, in style of by Diane Arbus"
```
