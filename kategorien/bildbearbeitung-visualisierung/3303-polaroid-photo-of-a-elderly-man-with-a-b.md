...
```
"Polaroid photo of a elderly man with a beard and glasses, expressive facial features, holding a bouquet of flowers, interacting with nature, Close up on the face, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From above in a high angle, Pentax 645Z, in style of by Annie Leibovitz"
```
