...
```
"pictorialist photo of a teenage girl with short curly red hair, expressive facial features, holding a bouquet of flowers, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Dutch angle, Lumix GH5, in style of by Annie Leibovitz"
```
