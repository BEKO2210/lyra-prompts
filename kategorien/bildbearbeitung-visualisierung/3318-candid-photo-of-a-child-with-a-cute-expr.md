...
```
"candid photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, interacting with nature, Upper body from behind, on a serene beach at golden hour, Soft diffused lighting, Dutch angle, Hasselblad X1D II, in style of by Helmut Newton"
```
