...
```
"beauty photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Bounced lighting, From above in a high angle, RED Digital Cinema Camera, in style of by Vivian Maier"
```
