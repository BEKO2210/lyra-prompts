...
```
"high fashion photo of a child with a cute expression and messy hair, striking tattoos, standing in front of a vintage car, striking a confident pose, Upper body from behind, amidst a field of wildflowers under a clear blue sky, Chiaroscuro with dramatic shadows, From below in a low angle, RED Digital Cinema Camera, in style of by Diane Arbus"
```
