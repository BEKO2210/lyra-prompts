...
```
"pictorialist photo of a young man wearing a suit and tie, expressive facial features, playing a musical instrument, interacting with nature, High angle view, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, From above in a high angle, Aaton LTR, in style of by Helmut Newton"
```
