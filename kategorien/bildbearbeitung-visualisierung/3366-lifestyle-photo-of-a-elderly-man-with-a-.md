...
```
"lifestyle photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, striking a confident pose, High angle view, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Dutch angle, Hasselblad X1D II, in style of by Steve McCurry"
```
