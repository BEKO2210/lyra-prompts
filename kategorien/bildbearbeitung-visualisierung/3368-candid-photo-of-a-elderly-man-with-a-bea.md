...
```
"candid photo of a elderly man with a beard and glasses, striking tattoos, wearing a sundress, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Bounced lighting, From above in a high angle, RED Digital Cinema Camera, in style of by Steve McCurry"
```
