...
```
"high fashion photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, striking a confident pose, Full body shot, inside a cozy cabin with a roaring fireplace, Soft diffused lighting, From below in a low angle, ARRI ALEXA 65, in style of by Annie Leibovitz"
```
