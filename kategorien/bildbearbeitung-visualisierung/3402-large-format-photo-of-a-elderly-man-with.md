...
```
"large format photo of a elderly man with a beard and glasses, captivating eyes, holding a cup of coffee, interacting with nature, Upper body from behind, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, From above in a high angle, RED Digital Cinema Camera, in style of by Steve McCurry"
```
