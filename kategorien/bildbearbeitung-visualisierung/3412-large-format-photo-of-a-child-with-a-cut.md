...
```
"large format photo of a child with a cute expression and messy hair, unique hairstyle, holding a bouquet of flowers, in mid-dance move, Head shot with dramatic lighting, on a serene beach at golden hour, Chiaroscuro with dramatic shadows, Dutch angle, Lumix GH5, in style of by Annie Leibovitz"
```
