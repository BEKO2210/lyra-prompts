...
```
"Analog photo of a middle-aged woman with fair skin and a friendly smile, expressive facial features, wearing a sundress, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Bounced lighting, From below in a low angle, Bolex H16, in style of by Vivian Maier"
```
