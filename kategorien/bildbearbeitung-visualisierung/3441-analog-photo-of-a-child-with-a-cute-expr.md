...
```
"Analog photo of a child with a cute expression and messy hair, expressive facial features, holding a bouquet of flowers, interacting with nature, High angle view, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Golden hour light casting a warm glow, Dutch angle, Canon EOS 5D, in style of by Vivian Maier"
```
