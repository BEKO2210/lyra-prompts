...
```
"candid photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, striking a confident pose, Upper body from behind, on a serene beach at golden hour, Bounced lighting, Dutch angle, Hasselblad X1D II, in style of by Annie Leibovitz"
```
