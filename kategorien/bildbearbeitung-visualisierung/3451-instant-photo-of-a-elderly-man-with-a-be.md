...
```
"instant photo of a elderly man with a beard and glasses, expressive facial features, holding a bouquet of flowers, striking a confident pose, Head shot with dramatic lighting, on a serene beach at golden hour, Chiaroscuro with dramatic shadows, From above in a high angle, Aaton LTR, in style of by Diane Arbus"
```
