...
```
"Analog photo of a child with a cute expression and messy hair, expressive facial features, holding a bouquet of flowers, in mid-dance move, Head shot with dramatic lighting, on a serene beach at golden hour, Chiaroscuro with dramatic shadows, From above in a high angle, Bolex H16, in style of by Annie Leibovitz"
```
