...
```
"large format photo of a elderly man with a beard and glasses, expressive facial features, wearing a sundress, interacting with nature, Upper body from behind, in a bustling city square during sunset, Cinematic lighting with moody ambiance, From below in a low angle, Bolex H16, in style of by Diane Arbus"
```
