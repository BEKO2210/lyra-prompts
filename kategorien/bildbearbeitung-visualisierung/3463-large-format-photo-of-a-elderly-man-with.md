...
```
"large format photo of a elderly man with a beard and glasses, striking tattoos, standing in front of a vintage car, striking a confident pose, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Chiaroscuro with dramatic shadows, Dutch angle, RED Digital Cinema Camera, in style of by Vivian Maier"
```
