...
```
"large format photo of a young man wearing a suit and tie, intricate jewelry, wearing a sundress, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Bounced lighting, From below in a low angle, Fujifilm X-T4, in style of by Steve McCurry"
```
