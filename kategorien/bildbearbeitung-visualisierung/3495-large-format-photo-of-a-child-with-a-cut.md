...
```
"large format photo of a child with a cute expression and messy hair, expressive facial features, playing a musical instrument, interacting with nature, Full body shot, on a serene beach at golden hour, Golden hour light casting a warm glow, Dutch angle, Lumix GH5, in style of by Vivian Maier"
```
