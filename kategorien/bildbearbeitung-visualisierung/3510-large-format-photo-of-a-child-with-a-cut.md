...
```
"large format photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, looking contemplative, Upper body from behind, on a serene beach at golden hour, Bounced lighting, From above in a high angle, Canon EOS 5D, in style of by Helmut Newton"
```
