...
```
"high fashion photo of a child with a cute expression and messy hair, expressive facial features, holding a bouquet of flowers, interacting with nature, Full body shot, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Soft diffused lighting, From below in a low angle, Bolex H16, in style of by Annie Leibovitz"
```
