...
```
"Polaroid photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, smiling excitedly, Close up on the face, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Eye level, Aaton LTR, in style of by Vivian Maier"
```
