...
```
"Polaroid photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, in a bustling city square during sunset, Chiaroscuro with dramatic shadows, From above in a high angle, Fujifilm X-T4, in style of by Vivian Maier"
```
