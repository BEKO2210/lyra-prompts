...
```
"high fashion photo of a teenage girl with short curly red hair, intricate jewelry, playing a musical instrument, striking a confident pose, Upper body from behind, on a serene beach at golden hour, Soft diffused lighting, Eye level, RED Digital Cinema Camera, in style of by Steve McCurry"
```
