...
```
"paparazzi photo of a elderly man with a beard and glasses, captivating eyes, holding a cup of coffee, striking a confident pose, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Golden hour light casting a warm glow, Eye level, Lumix GH5, in style of by Steve McCurry"
```
