...
```
"pictorialist photo of a elderly man with a beard and glasses, expressive facial features, playing a musical instrument, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Soft diffused lighting, Eye level, Bolex H16, in style of by Annie Leibovitz"
```
