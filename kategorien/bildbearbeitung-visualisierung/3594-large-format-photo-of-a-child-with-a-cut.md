...
```
"large format photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, smiling excitedly, Full body shot, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Eye level, Fujifilm X-T4, in style of by Annie Leibovitz"
```
