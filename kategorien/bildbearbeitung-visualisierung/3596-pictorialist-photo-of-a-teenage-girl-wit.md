...
```
"pictorialist photo of a teenage girl with short curly red hair, expressive facial features, wearing a sundress, striking a confident pose, High angle view, on a serene beach at golden hour, Cinematic lighting with moody ambiance, Dutch angle, Canon EOS 5D, in style of by Steve McCurry"
```
