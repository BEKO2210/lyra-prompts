...
```
"lifestyle photo of a teenage girl with short curly red hair, expressive facial features, standing in front of a vintage car, striking a confident pose, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Chiaroscuro with dramatic shadows, Eye level, RED Digital Cinema Camera, in style of by Steve McCurry"
```
