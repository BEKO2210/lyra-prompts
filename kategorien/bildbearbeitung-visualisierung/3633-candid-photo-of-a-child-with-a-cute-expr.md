...
```
"candid photo of a child with a cute expression and messy hair, unique hairstyle, wearing a sundress, in mid-dance move, Head shot with dramatic lighting, on a serene beach at golden hour, Golden hour light casting a warm glow, Dutch angle, RED Digital Cinema Camera, in style of by Annie Leibovitz"
```
