...
```
"candid photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Soft diffused lighting, Dutch angle, RED Digital Cinema Camera, in style of by Steve McCurry"
```
