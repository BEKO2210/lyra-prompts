...
```
"large format photo of a young man wearing a suit and tie, expressive facial features, wearing a sundress, interacting with nature, High angle view, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Eye level, Lumix GH5, in style of by Steve McCurry"
```
