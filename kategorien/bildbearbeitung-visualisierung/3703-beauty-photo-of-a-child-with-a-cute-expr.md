...
```
"beauty photo of a child with a cute expression and messy hair, intricate jewelry, standing in front of a vintage car, interacting with nature, Upper body from behind, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Bounced lighting, From below in a low angle, Pentax 645Z, in style of by Diane Arbus"
```
