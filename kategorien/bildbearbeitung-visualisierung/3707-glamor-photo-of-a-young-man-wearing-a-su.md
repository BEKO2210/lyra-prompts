...
```
"glamor photo of a young man wearing a suit and tie, unique hairstyle, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Bounced lighting, From below in a low angle, Aaton LTR, in style of by Helmut Newton"
```
