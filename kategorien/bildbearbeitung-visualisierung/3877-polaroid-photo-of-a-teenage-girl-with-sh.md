...
```
"Polaroid photo of a teenage girl with short curly red hair, intricate jewelry, standing in front of a vintage car, striking a confident pose, Head shot with dramatic lighting, on a serene beach at golden hour, Cinematic lighting with moody ambiance, Eye level, Hasselblad X1D II, in style of by Vivian Maier"
```
