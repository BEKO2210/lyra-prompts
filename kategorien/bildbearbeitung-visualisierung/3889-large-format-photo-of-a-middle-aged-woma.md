...
```
"large format photo of a middle-aged woman with fair skin and a friendly smile, captivating eyes, standing in front of a vintage car, striking a confident pose, Head shot with dramatic lighting, on a serene beach at golden hour, Chiaroscuro with dramatic shadows, From above in a high angle, RED Digital Cinema Camera, in style of by Vivian Maier"
```
