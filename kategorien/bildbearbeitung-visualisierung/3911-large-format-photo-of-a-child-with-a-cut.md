...
```
"large format photo of a child with a cute expression and messy hair, intricate jewelry, standing in front of a vintage car, looking contemplative, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Soft diffused lighting, From below in a low angle, Canon EOS 5D, in style of by Annie Leibovitz"
```
