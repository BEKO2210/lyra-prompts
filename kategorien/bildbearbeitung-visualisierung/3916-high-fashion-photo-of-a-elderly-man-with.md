...
```
"high fashion photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, striking a confident pose, Close up on the face, amidst a field of wildflowers under a clear blue sky, Bounced lighting, From above in a high angle, Bolex H16, in style of by Helmut Newton"
```
