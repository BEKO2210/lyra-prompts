...
```
"Analog photo of a teenage girl with short curly red hair, striking tattoos, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Bounced lighting, Eye level, Hasselblad X1D II, in style of by Diane Arbus"
```
