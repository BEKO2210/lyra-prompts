...
```
"Polaroid photo of a elderly man with a beard and glasses, expressive facial features, playing a musical instrument, interacting with nature, Full body shot, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Canon EOS 5D, in style of by Annie Leibovitz"
```
