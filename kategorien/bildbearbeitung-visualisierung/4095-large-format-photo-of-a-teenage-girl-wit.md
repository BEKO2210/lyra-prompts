...
```
"large format photo of a teenage girl with short curly red hair, striking tattoos, playing a musical instrument, striking a confident pose, Head shot with dramatic lighting, in a bustling city square during sunset, Cinematic lighting with moody ambiance, Eye level, Hasselblad X1D II, in style of by Annie Leibovitz"
```
