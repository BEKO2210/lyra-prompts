...
```
"instant photo of a child with a cute expression and messy hair, unique hairstyle, holding a bouquet of flowers, interacting with nature, Head shot with dramatic lighting, in a bustling city square during sunset, Cinematic lighting with moody ambiance, Eye level, RED Digital Cinema Camera, in style of by Annie Leibovitz"
```
