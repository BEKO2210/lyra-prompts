...
```
"beauty photo of a elderly man with a beard and glasses, expressive facial features, wearing a sundress, interacting with nature, Close up on the face, on a serene beach at golden hour, Cinematic lighting with moody ambiance, Eye level, Bolex H16, in style of by Annie Leibovitz"
```
