...
```
"paparazzi photo of a young man wearing a suit and tie, expressive facial features, standing in front of a vintage car, striking a confident pose, High angle view, in a bustling city square during sunset, Cinematic lighting with moody ambiance, Eye level, Aaton LTR, in style of by Vivian Maier"
```
