...
```
"lifestyle photo of a child with a cute expression and messy hair, unique hairstyle, playing a musical instrument, interacting with nature, High angle view, on a serene beach at golden hour, Bounced lighting, From above in a high angle, Aaton LTR, in style of by Steve McCurry"
```
