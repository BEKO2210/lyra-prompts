...
```
"instant photo of a child with a cute expression and messy hair, expressive facial features, playing a musical instrument, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Soft diffused lighting, From below in a low angle, ARRI ALEXA 65, in style of by Diane Arbus"
```
