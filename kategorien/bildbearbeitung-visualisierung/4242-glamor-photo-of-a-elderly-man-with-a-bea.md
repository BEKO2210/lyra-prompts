...
```
"glamor photo of a elderly man with a beard and glasses, unique hairstyle, holding a cup of coffee, interacting with nature, High angle view, on a serene beach at golden hour, Soft diffused lighting, From below in a low angle, Aaton LTR, in style of by Annie Leibovitz"
```
