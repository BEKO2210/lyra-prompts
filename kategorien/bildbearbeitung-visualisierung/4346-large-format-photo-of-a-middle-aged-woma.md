...
```
"large format photo of a middle-aged woman with fair skin and a friendly smile, intricate jewelry, playing a musical instrument, interacting with nature, High angle view, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Pentax 645Z, in style of by Annie Leibovitz"
```
