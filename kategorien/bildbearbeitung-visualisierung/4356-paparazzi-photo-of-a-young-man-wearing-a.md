...
```
"paparazzi photo of a young man wearing a suit and tie, expressive facial features, playing a musical instrument, interacting with nature, Upper body from behind, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Dutch angle, Bolex H16, in style of by Diane Arbus"
```
