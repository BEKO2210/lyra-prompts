...
```
"large format photo of a young man wearing a suit and tie, expressive facial features, wearing a sundress, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Chiaroscuro with dramatic shadows, From below in a low angle, Fujifilm X-T4, in style of by Vivian Maier"
```
