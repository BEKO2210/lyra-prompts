...
```
"large format photo of a young man wearing a suit and tie, expressive facial features, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Chiaroscuro with dramatic shadows, Eye level, Hasselblad X1D II, in style of by Steve McCurry"
```
