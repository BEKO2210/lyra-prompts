...
```
"Analog photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, in mid-dance move, Head shot with dramatic lighting, in a bustling city square during sunset, Golden hour light casting a warm glow, Eye level, Aaton LTR, in style of by Diane Arbus"
```
