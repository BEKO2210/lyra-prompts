...
```
"lifestyle photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Bounced lighting, From below in a low angle, Canon EOS 5D, in style of by Helmut Newton"
```
