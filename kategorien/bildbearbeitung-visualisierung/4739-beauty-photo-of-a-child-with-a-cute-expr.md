...
```
"beauty photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, smiling excitedly, Head shot with dramatic lighting, on a serene beach at golden hour, Chiaroscuro with dramatic shadows, Eye level, RED Digital Cinema Camera, in style of by Steve McCurry"
```
