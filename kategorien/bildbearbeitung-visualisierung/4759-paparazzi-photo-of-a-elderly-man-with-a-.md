...
```
"paparazzi photo of a elderly man with a beard and glasses, expressive facial features, playing a musical instrument, interacting with nature, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Chiaroscuro with dramatic shadows, Eye level, Fujifilm X-T4, in style of by Steve McCurry"
```
