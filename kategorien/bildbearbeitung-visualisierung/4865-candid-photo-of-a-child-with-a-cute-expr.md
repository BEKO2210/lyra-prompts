...
```
"candid photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, smiling excitedly, High angle view, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Fujifilm X-T4, in style of by Vivian Maier"
```
