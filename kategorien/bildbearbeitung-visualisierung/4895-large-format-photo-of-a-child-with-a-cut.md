...
```
"large format photo of a child with a cute expression and messy hair, intricate jewelry, wearing a sundress, interacting with nature, Head shot with dramatic lighting, in a bustling city square during sunset, Soft diffused lighting, Eye level, Fujifilm X-T4, in style of by Helmut Newton"
```
