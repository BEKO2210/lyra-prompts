...
```
"Polaroid photo of a young man wearing a suit and tie, unique hairstyle, wearing a sundress, interacting with nature, Head shot with dramatic lighting, amidst a field of wildflowers under a clear blue sky, Golden hour light casting a warm glow, From below in a low angle, RED Digital Cinema Camera, in style of by Annie Leibovitz"
```
