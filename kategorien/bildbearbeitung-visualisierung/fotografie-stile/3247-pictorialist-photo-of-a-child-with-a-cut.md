...
```
"pictorialist photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, striking a confident pose, Head shot with dramatic lighting, on a serene beach at golden hour, Soft diffused lighting, From above in a high angle, ARRI ALEXA 65, in style of by Helmut Newton"
```
