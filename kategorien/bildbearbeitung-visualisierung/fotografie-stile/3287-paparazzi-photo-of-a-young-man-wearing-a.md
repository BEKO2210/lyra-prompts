...
```
"paparazzi photo of a young man wearing a suit and tie, unique hairstyle, playing a musical instrument, interacting with nature, High angle view, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Lumix GH5, in style of by Steve McCurry"
```
