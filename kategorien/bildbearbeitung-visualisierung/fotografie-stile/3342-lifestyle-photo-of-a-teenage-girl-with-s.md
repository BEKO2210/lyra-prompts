...
```
"lifestyle photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, in mid-dance move, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Golden hour light casting a warm glow, Eye level, Aaton LTR, in style of by Steve McCurry"
```
