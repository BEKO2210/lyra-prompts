...
```
"large format photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, interacting with nature, Close up on the face, inside a cozy cabin with a roaring fireplace, Bounced lighting, Dutch angle, Lumix GH5, in style of by Steve McCurry"
```
