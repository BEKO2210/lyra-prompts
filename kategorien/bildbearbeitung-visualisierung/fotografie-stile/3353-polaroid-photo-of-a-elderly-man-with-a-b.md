...
```
"Polaroid photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, striking a confident pose, High angle view, on a serene beach at golden hour, Golden hour light casting a warm glow, From above in a high angle, Aaton LTR, in style of by Diane Arbus"
```
