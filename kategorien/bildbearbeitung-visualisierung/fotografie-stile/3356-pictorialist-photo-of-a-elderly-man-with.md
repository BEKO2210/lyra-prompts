...
```
"pictorialist photo of a elderly man with a beard and glasses, intricate jewelry, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Soft diffused lighting, From above in a high angle, Lumix GH5, in style of by Helmut Newton"
```
