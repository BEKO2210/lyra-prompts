...
```
"Polaroid photo of a middle-aged woman with fair skin and a friendly smile, captivating eyes, wearing a sundress, in mid-dance move, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Eye level, Fujifilm X-T4, in style of by Helmut Newton"
```
