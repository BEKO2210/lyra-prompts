...
```
"beauty photo of a elderly man with a beard and glasses, captivating eyes, playing a musical instrument, interacting with nature, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Bounced lighting, Eye level, Aaton LTR, in style of by Annie Leibovitz"
```
