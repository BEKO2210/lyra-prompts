...
```
"pictorialist photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, in mid-dance move, Close up on the face, on a serene beach at golden hour, Soft diffused lighting, From above in a high angle, Hasselblad X1D II, in style of by Annie Leibovitz"
```
