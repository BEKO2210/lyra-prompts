...
```
"high fashion photo of a elderly man with a beard and glasses, unique hairstyle, playing a musical instrument, striking a confident pose, Upper body from behind, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, From above in a high angle, Lumix GH5, in style of by Annie Leibovitz"
```
