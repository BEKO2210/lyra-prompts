...
```
"pictorialist photo of a child with a cute expression and messy hair, expressive facial features, wearing a sundress, interacting with nature, Full body shot, on a serene beach at golden hour, Soft diffused lighting, From above in a high angle, Canon EOS 5D, in style of by Diane Arbus"
```
