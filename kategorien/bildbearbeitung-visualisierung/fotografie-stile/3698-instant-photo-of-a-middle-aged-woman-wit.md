...
```
"instant photo of a middle-aged woman with fair skin and a friendly smile, captivating eyes, holding a cup of coffee, interacting with nature, High angle view, inside a cozy cabin with a roaring fireplace, Cinematic lighting with moody ambiance, Eye level, Lumix GH5, in style of by Helmut Newton"
```
