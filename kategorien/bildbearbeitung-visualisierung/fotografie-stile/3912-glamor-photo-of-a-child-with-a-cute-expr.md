...
```
"glamor photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, looking contemplative, High angle view, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, Eye level, Aaton LTR, in style of by Vivian Maier"
```
