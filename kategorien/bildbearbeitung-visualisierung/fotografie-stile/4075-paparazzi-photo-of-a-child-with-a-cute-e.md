...
```
"paparazzi photo of a child with a cute expression and messy hair, captivating eyes, standing in front of a vintage car, interacting with nature, Head shot with dramatic lighting, inside a cozy cabin with a roaring fireplace, Soft diffused lighting, Eye level, Bolex H16, in style of by Diane Arbus"
```
