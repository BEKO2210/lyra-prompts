...
```
"high fashion photo of a child with a cute expression and messy hair, striking tattoos, playing a musical instrument, interacting with nature, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Eye level, Lumix GH5, in style of by Steve McCurry"
```
