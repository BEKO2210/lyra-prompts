...
```
"Polaroid photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, interacting with nature, Head shot with dramatic lighting, in a bustling city square during sunset, Soft diffused lighting, From below in a low angle, Canon EOS 5D, in style of by Vivian Maier"
```
