...
```
"lifestyle photo of a teenage girl with short curly red hair, unique hairstyle, standing in front of a vintage car, interacting with nature, High angle view, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Golden hour light casting a warm glow, Eye level, Lumix GH5, in style of by Steve McCurry"
```
