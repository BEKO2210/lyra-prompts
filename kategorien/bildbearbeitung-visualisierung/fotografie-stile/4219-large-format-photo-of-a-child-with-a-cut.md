...
```
"large format photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, striking a confident pose, High angle view, in a bustling city square during sunset, Golden hour light casting a warm glow, From above in a high angle, Canon EOS 5D, in style of by Helmut Newton"
```
