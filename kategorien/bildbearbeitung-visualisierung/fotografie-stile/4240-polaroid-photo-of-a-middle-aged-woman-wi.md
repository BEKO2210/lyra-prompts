...
```
"Polaroid photo of a middle-aged woman with fair skin and a friendly smile, intricate jewelry, standing in front of a vintage car, striking a confident pose, Upper body from behind, on a serene beach at golden hour, Bounced lighting, From below in a low angle, Aaton LTR, in style of by Annie Leibovitz"
```
