...
```
"paparazzi photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, interacting with nature, High angle view, inside a cozy cabin with a roaring fireplace, Golden hour light casting a warm glow, Dutch angle, Fujifilm X-T4, in style of by Annie Leibovitz"
```
