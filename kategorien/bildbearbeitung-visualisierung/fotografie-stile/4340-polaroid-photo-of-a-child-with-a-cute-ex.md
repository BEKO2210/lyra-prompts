...
```
"Polaroid photo of a child with a cute expression and messy hair, unique hairstyle, standing in front of a vintage car, striking a confident pose, Upper body from behind, on a serene beach at golden hour, Cinematic lighting with moody ambiance, Dutch angle, Bolex H16, in style of by Diane Arbus"
```
