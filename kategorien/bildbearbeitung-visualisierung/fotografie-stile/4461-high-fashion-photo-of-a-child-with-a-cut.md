...
```
"high fashion photo of a child with a cute expression and messy hair, intricate jewelry, playing a musical instrument, striking a confident pose, Head shot with dramatic lighting, on a serene beach at golden hour, Soft diffused lighting, From below in a low angle, Canon EOS 5D, in style of by Diane Arbus"
```
