...
```
"Polaroid photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, in mid-dance move, Upper body from behind, in a bustling city square during sunset, Golden hour light casting a warm glow, Eye level, Hasselblad X1D II, in style of by Helmut Newton"
```
