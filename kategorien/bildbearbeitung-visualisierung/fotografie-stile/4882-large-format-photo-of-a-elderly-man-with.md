...
```
"large format photo of a elderly man with a beard and glasses, expressive facial features, standing in front of a vintage car, in mid-dance move, Upper body from behind, in a bustling city square during sunset, Cinematic lighting with moody ambiance, From above in a high angle, RED Digital Cinema Camera, in style of by Vivian Maier"
```
