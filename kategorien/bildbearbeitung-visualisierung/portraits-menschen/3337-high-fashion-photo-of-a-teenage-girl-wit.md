...
```
"high fashion photo of a teenage girl with short curly red hair, expressive facial features, playing a musical instrument, interacting with nature, Close up on the face, on a serene beach at golden hour, Soft diffused lighting, From below in a low angle, Bolex H16, in style of by Steve McCurry"
```
