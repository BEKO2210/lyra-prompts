...
```
"candid photo of a teenage girl with short curly red hair, expressive facial features, holding a cup of coffee, interacting with nature, Head shot with dramatic lighting, in a bustling city square during sunset, Bounced lighting, Eye level, RED Digital Cinema Camera, in style of by Annie Leibovitz"
```
