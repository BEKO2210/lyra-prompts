...
```
"instant photo of a middle-aged woman with fair skin and a friendly smile, expressive facial features, wearing a sundress, interacting with nature, Upper body from behind, on a serene beach at golden hour, Bounced lighting, From below in a low angle, Hasselblad X1D II, in style of by Helmut Newton"
```
