...
```
"paparazzi photo of a elderly man with a beard and glasses, expressive facial features, playing a musical instrument, smiling excitedly, Head shot with dramatic lighting, on a rocky edge of a cliff overlooking a misty forested valley at dawn, Cinematic lighting with moody ambiance, Dutch angle, Hasselblad X1D II, in style of by Annie Leibovitz"
```
