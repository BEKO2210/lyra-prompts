...
```
"Analog photo of a elderly man with a beard and glasses, expressive facial features, wearing a sundress, interacting with nature, High angle view, on a serene beach at golden hour, Bounced lighting, From below in a low angle, RED Digital Cinema Camera, in style of by Diane Arbus"
```
