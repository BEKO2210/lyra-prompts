...
```
"pictorialist photo of a child with a cute expression and messy hair, expressive facial features, standing in front of a vintage car, smiling excitedly, Upper body from behind, on a serene beach at golden hour, Cinematic lighting with moody ambiance, From below in a low angle, Bolex H16, in style of by Annie Leibovitz"
```
