...
```
"high fashion photo of a teenage girl with short curly red hair, expressive facial features, playing a musical instrument, in mid-dance move, Upper body from behind, on a serene beach at golden hour, Soft diffused lighting, Eye level, Aaton LTR, in style of by Helmut Newton"
```
