---
id: "#3544"
titel: "Create a function that take a string and extract just the di"
kategorie: "Kreativitaet & Freizeit"
unterkategorie: "Importiert"
tags: ["function", "string", "extract", "distance", "kilometers"]
...
```
create a function that take a string and extract just the distance in kilometers from it
```
