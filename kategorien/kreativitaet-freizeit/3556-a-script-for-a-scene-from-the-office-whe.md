---
id: "#3556"
titel: "A script for a scene from The Office where Michael Scott is"
kategorie: "Kreativitaet & Freizeit"
unterkategorie: "Importiert"
tags: ["script", "scene", "office", "where", "michael"]
...
```
Create a script for a scene from The Office where Michael Scott is trying to learn how to use TikTok.
```
