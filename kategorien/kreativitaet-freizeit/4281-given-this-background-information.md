...
<end of reference>
Which genre of literature does the poem fall under? No details other than the genre name please.
```

## Anwendung

**Thema: One Foot, Good Things** — Perfekt fuer alle, die neue Rezeptideen suchen oder ihre Kochkuenste erweitern wollen. Die KI erstellt ein vollstaendiges Rezept mit Zutaten und Anleitung.
