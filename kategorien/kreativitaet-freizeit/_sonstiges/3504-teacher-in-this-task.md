...
tags: ["teacher", "task", "given", "context", "sentence"]
...
Teacher: Now, understand the problem? Solve this instance: Context: None 
 Sentence: A man had a heart attack while driving today. 
 Character: Passenger vehicle
Student:
```
