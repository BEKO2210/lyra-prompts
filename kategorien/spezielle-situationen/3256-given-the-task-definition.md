...
New input case for you: Question: Bonnie is studying cells. She notices that certain cells are active. The cells that are active have 
 Answer: more mitochondria
Output:
```
