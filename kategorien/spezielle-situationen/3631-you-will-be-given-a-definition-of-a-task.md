...
tags: ["given", "definition", "task", "input", "questions"]
...
original question: Find telescope whose type is [Neutrino detector].
paraphrase: Where can I find a [Neutrino detector]?
Output:
```
