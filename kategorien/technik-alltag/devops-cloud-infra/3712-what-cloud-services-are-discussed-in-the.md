---
id: "#3712"
titel: "What cloud services are discussed in the following text : 'C"
kategorie: "Technik & Alltag"
unterkategorie: "DevOps, Cloud & Infrastruktur"
tags: ["cloud", "services", "discussed", "text", "bucket"]
...
```
What cloud services are discussed in the following text : "Create an S3 bucket with a lambda and give access to it and an ELB over two EC2 and 50% traffic'
```
