---
id: "#3722"
titel: "A terraform script to create an s3 bucket which can receive"
kategorie: "Technik & Alltag"
unterkategorie: "DevOps, Cloud & Infrastruktur"
tags: ["terraform", "script", "bucket", "receive", "data"]
...
```
Write a terraform script to create an s3 bucket which can receive data from an application deployed in eks
```
