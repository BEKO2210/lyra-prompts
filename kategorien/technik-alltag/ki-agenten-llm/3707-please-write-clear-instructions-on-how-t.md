---
id: "#3707"
titel: "Please write clear instructions on how to implement a"
kategorie: "Technik & Alltag"
unterkategorie: "KI, Agenten & LLM"
tags: ["clear", "instructions", "implement", "middleware", "identity"]
...
```
please write clear instructions on how to implement a .net 6 middleware in identity server 6 to modify the httpcontext.user and assign a new identity with the id of the target user to be modified
```
