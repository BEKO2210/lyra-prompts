---
id: "#3720"
titel: "Write a p5js program that will draw a whole bunch of points"
kategorie: "Technik & Alltag"
unterkategorie: "KI, Agenten & LLM"
tags: ["program", "draw", "whole", "bunch", "points"]
...
```
write a p5js program that will draw a whole bunch of points with lines that slowly crawl out of the points from in different colors
```
