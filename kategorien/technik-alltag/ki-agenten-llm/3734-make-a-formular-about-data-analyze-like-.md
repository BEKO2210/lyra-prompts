---
id: "#3734"
titel: "Make a formular about data analyze like this format"
kategorie: "Technik & Alltag"
unterkategorie: "KI, Agenten & LLM"
tags: ["formular", "data", "analyze", "format", "model"]
...
```
make a formular about data analyze like this format:
ML model = Business problem + Data + Algorithm
```
