---
id: "#3745"
titel: "I want to build an electron js app"
kategorie: "Technik & Alltag"
unterkategorie: "KI, Agenten & LLM"
tags: ["build", "electron", "buttons", "user", "clicks"]
...
```
i want to build an electron js app , that has few buttons , so when the user a clicks a button means it should send a sos alert to users whatsapp give me idea on how to built , libraries required,
```
