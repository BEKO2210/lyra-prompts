---
id: "#3727"
titel: "A command to extract the Node IP Address and the sitename be"
kategorie: "Technik & Alltag"
unterkategorie: "Web- & App-Entwicklung"
tags: ["command", "extract", "node", "address", "sitename"]
...
```
Write a command to extract the Node IP Address and the sitename between "connect to node :" and "CollectionDataTask" and tab separate them 
